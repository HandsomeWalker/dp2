...
----------------------------------------------------------------------------以下是菜单----------------------------------------------------------------------------
    if input == "//指令" then
		...
		user:SendNotiPacketMessage("功能：分解装备【诺顿】  指令：//disjoint1", 14)
		user:SendNotiPacketMessage("功能：分解装备【分解机】  指令：//disjoint2", 14)
		user:SendNotiPacketMessage("功能：出售装备  指令：//sell", 14)
        user:SendNotiPacketMessage("功能：翻牌自动回城模式  指令：//finishBackHomeM", 14)
        user:SendNotiPacketMessage("M的值为0,1,2,3,4", 14)
        user:SendNotiPacketMessage("//finishBackHome0---关闭翻牌回城", 14)
        user:SendNotiPacketMessage("//finishBackHome1---打开翻牌回城", 14)
        user:SendNotiPacketMessage("//finishBackHome2---翻牌回城分解装备(诺顿)", 14)
        user:SendNotiPacketMessage("//finishBackHome3---翻牌回城分解装备(在线玩家分解机)", 14)
        user:SendNotiPacketMessage("//finishBackHome4---翻牌回城出售装备", 14)
